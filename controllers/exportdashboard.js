...
// Coupon List Data (without response object)
const getCouponListData = async (shopId, page = 1, limit = 10, search, status) => {
    try {
...
// Sales Analytics Data (without response object)
const getSalesAnalyticsData = async (shopId, startDate, endDate) => {
    try {
        const dateFilter = {};
        if (startDate && endDate) {
            dateFilter.createdAt = {
...
// Coupon User Analytics Data (without response object)
const getCouponUserAnalyticsData = async (couponId, startDate, endDate) => {
    try {
        const dateFilter = {};
        if (startDate && endDate) {
            dateFilter.createdAt = {
...
// === ORIGINAL CONTROLLER FUNCTIONS (with response objects) ===
...
export const getDashboardAnalytics = async (req, res) => {
    try {
        ...
        const result = await getDashboardAnalyticsData(shopId, startDate, endDate);
...
export const getCouponList = async (req, res) => {
    try {
        ...
        const result = await getCouponListData(shopId, page, limit, search, status);
...
export const getCouponUserAnalytics = async (req, res) => {
    try {
        ...
        const result = await getCouponUserAnalyticsData(couponId, startDate, endDate);
...
export const getSalesAnalytics = async (req, res) => {
    try {
        ...
        const result = await getSalesAnalyticsData(shopId, startDate, endDate);
...
// === INTERNAL HELPERS (for PDF export) ===
const fetchDashboardAnalyticsData = async (userId, startDate, endDate) => {
    return await getDashboardAnalyticsData(userId, startDate, endDate);
};

const fetchCouponListData = async (userId, limit = 5) => {
    return await getCouponListData(userId, 1, limit);
};

const fetchSalesAnalyticsData = async (userId, startDate, endDate) => {
    return await getSalesAnalyticsData(userId, startDate, endDate);
};

const fetchCouponUserAnalyticsData = async (startDate, endDate) => {
    return await getCouponUserAnalyticsData(null, startDate, endDate);
};
