...
//     // Parse cursor if provided - with better error handling
//     let cursorObj = null;
//     if (cursor) {
//       try {
...
//           const timestamp = parseInt(cursorParts[1]);
//           cursorObj = {
//             distance: parseFloat(cursorParts[0]),
//             createdAt: isNaN(timestamp) ? null : new Date(timestamp),
...
//     // Generate next cursor from the last item - with null checks
//     let nextCursor = null;
